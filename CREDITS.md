...
- 몬스터: **KayKit "Character Pack: Skeletons" — Minion/Warrior/Rogue/Mage** (Kay Lousberg), **CC0**.
...
- **연기 텍스처** — `assets/vfx/smoke.png`, three.js 예제(CC0/MIT).
- 글로우/충격파 링/스파크/마법진은 런타임 캔버스로 생성(파일 불필요).
